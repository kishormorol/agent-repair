...
original historical pool was not downloaded or compared and undocumented
runs cannot be ruled out. Position controls fit 24 main-study development
failures and 6--19 per replication cell; realized replication imbalance
limits attribution to uncertainty beyond position. A nonsignificant
difference is not evidence of equivalence. Bootstrap intervals lack
simultaneous family-wise coverage; sign-flip inference requires within-question
exchangeability. Shared seeds or executions do not add independent questions.
...
annotations and unrecovered historical raw trials are not supplied. Appendix~\ref{app:availability} distinguishes verification from
...
Most pairs tie (Table~\ref{tab:position_pair_blocks}), which is the binding
precision limit rather than the effect size. The exact test's resolution is
