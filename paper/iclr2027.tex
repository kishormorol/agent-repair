...
reached a conventional level whatever their outcomes. More questions alone
would not fix it: the cell with the most pairs shares the highest floor because
its extra pairs were ties (Appendix~\ref{app:position_pairs}).
