% =========================================================================== %
%  SUPERSEDED. DO NOT EDIT, CITE, OR SUBMIT THIS FILE.
%
%  This is an earlier manuscript, kept only as a record. Its central claim ---
%  that uncertainty-guided strategies consistently outperform random-step
%  repair --- is NOT supported by the audited experiments that replaced it.
%  Under a length-matched control with exactly balanced repair origins, the
%  comparison is null, and the sign of the effect follows the dataset rather
%  than the model.
%
%  The live manuscript is paper/iclr2027.tex. If you are reviewing or editing
%  the paper, that is the file you want. If your Overleaf project opened this
%  one, it chose it by filename; set Menu -> Settings -> Main document to
%  paper/iclr2027.tex.
%
%  Note also that this file's abstract footnotes the public repository. Anyone
%  following that link reaches the current null result.
% =========================================================================== %
...
\begin{center}
\fbox{\parbox{0.9\linewidth}{\textbf{SUPERSEDED DRAFT --- NOT A SUBMISSION.}
This earlier manuscript is retained only as a record. Its claim that
uncertainty-guided repair outperforms random-step repair is not supported by
the audited experiments that replaced it: under a length-matched control with
exactly balanced repair origins the comparison is null. See
\texttt{paper/iclr2027.tex} for the current manuscript.}}
\end{center}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures-old/fig_cross_dataset_bars.png}
...
\begin{figure}[!b]
\centering
\includegraphics[width=\columnwidth]{figures-old/fig_backtracking_gain.png}
...
\begin{figure}[!b]
\centering
\includegraphics[width=\columnwidth]{figures-old/fig_localization_heatmap.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures-old/fig_traj_length_vs_repair.png}
...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{figures-old/fig_pareto_all_datasets.png}
